const equipment = [
  ...
  },
  {
    ...
    section: "Siłownia",
    group: "Wolne ciężary",
    name: "Obciążenie olimpijskie Fractional Competition PROUD 0,5-2,5 kg",
    quantity: "1 zestaw",
    priceRaw: 749.99,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/talerze/2335-zestaw-obciazen-olimpijskich-proud-competition-fractional-plate.html",
    image: "assets/images/gym-pro/gym-fractional-plates.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
  ...
  },
  {
    ...
    name: "Stojak na obciążenia i gryfy olimpijskie PROUD",
    quantity: "1",
    priceRaw: 921.31,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/outlet/2373-stojak-na-obciazenia-i-gryfy-olimpijskie-proud.html",
    image: "assets/images/gym-pro/gym-plate-bar-rack.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
  ...
  },
  {
    ...
    section: "Siłownia",
    group: "Maszyny siłowe",
    name: "Wyciąg regulowany Dual Pulley PROUD Champion",
    quantity: "1",
    priceRaw: 21520.38,
    source: "Training Showroom, do potwierdzenia pod kątem miejsca w sali",
    url: "https://trainingshowroom.com/maszyny-silowe/2906-wyciag-regulowany-dual-pulley-proud-champion.html",
    image: "assets/images/gym-pro/gym-dual-pulley.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Maszyny siłowe",
    name: "Maszyna Leverage Chest Press PROUD Champion",
    quantity: "1",
    priceRaw: 20140.4,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/maszyny-silowe/2992-maszyna-leverage-chest-press-proud-champion.html",
    image: "assets/images/gym-pro/gym-chest-press.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Maszyny na plecy",
    name: "Ławka do wiosłowania PROUD Champion",
    quantity: "1",
    priceRaw: 8169.88,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/lawki-treningowe/2946-lawka-do-wioslowania-proud-champion.html",
    image: "assets/images/gym-pro/gym-row-bench.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
  ...
  },
  {
    ...
    section: "Siłownia",
    group: "Maszyny na nogi",
    name: "Maszyna do treningu łydek PROUD Champion",
    quantity: "1",
    priceRaw: 6284.21,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/maszyny-silowe/2938-maszyna-do-lydek-proud-champion.html",
    image: "assets/images/gym-pro/gym-calf-machine.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Ławki i gryfy",
    name: "Modlitewnik PROUD Champion",
    quantity: "1",
    priceRaw: 4502.57,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/champion/2970-modlitewnik-proud-champion.html?search_query=Modlitewnik",
    image: "assets/images/gym-pro/gym-preacher-curl.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Ławki i gryfy",
    name: "Gryf olimpijski treningowy łamany Curl Silver PROUD",
    quantity: "1",
    priceRaw: 499.99,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/sztangi/2596-gryf-olimpijski-treningowy-lamany-silver-proud.html",
    image: "assets/images/gym-pro/gym-ez-bar.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
  ...
  },
  {
    ...
    section: "Siłownia",
    group: "Drabinki i drobny sprzęt",
    name: "Podkładki do przysiadów PROUD",
    quantity: "1 komplet",
    priceRaw: 79.99,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/gumy-i-rollery/3356-podkladki-do-przysiadow-proud.html",
    image: "assets/images/gym-pro/gym-squat-wedges.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Trening funkcjonalny",
    name: "Worek treningowy Powerbag PROUD, zestaw 5-25 kg",
    quantity: "1 zestaw",
    priceRaw: 1689.72,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/pilki-i-worki/2609-worek-treningowy-powerbag-proud.html",
    image: "assets/images/gym-pro/gym-powerbag-set.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Trening funkcjonalny",
    name: "Stojak na worki treningowe Powerbag PROUD",
    quantity: "1",
    priceRaw: 2101.8,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/pilki-i-worki/2609-worek-treningowy-powerbag-proud.html",
    image: "assets/images/gym-pro/gym-powerbag-rack.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Ławki i gryfy",
    name: "Sztanga specjalistyczna do martwego ciągu Hex Bar PROUD",
    quantity: "1",
    priceRaw: 799.99,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/sztangi/2593-sztanga-specjalistyczna-do-martwego-ciagu-hex-bar.html",
    image: "assets/images/gym-pro/gym-hex-bar.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Trening funkcjonalny",
    name: "Skakanka treningowa Speed Rope 2.0 PROUD",
    quantity: "4 szt.",
    priceRaw: 169.64,
    unitNote: "42,41 zł za szt.",
    source: "Training Showroom",
    url: "https://trainingshowroom.com/sprzet-fitness/2544-skakanka-treningowa-proud-speed-rope-20.html",
    image: "assets/images/gym-pro/gym-speed-rope.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Drabinki i drobny sprzęt",
    name: "Pas kulturystyczny z łańcuchem PROUD",
    quantity: "1",
    priceRaw: 105.03,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/akcesoria/2545-pas-kulturystyczny-z-lancuchem-proud.html",
    image: "assets/images/gym-pro/gym-dip-belt.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Drabinki i drobny sprzęt",
    name: "Uchwyt obrotowy Land Mine PROUD EDGE",
    quantity: "1",
    priceRaw: 299,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/proud-edge/3552-uchwyt-obrotowy-land-mine-proud-edge.html",
    image: "assets/images/gym-pro/gym-landmine.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Drabinki i drobny sprzęt",
    name: "Karabińczyk do wyciągu, zestaw PROUD",
    quantity: "1 zestaw",
    priceRaw: 43.92,
    unitNote: "5 szt. w zestawie",
    source: "Training Showroom",
    url: "https://trainingshowroom.com/maszyny-silowe/3398-karabinczyk-do-wyciagu-zestaw-proud.html?search_query=Karabinczyk",
    image: "assets/images/gym-pro/gym-carabiner-set.png",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Drabinki i drobny sprzęt",
    name: "Uchwyt do wyciągu linowy PROUD",
    quantity: "1",
    priceRaw: 74.73,
    source: "Training Showroom",
    url: "https://trainingshowroom.com/maszyny-silowe/2624-uchwyt-do-wyciagu-linowy-proud.html",
    image: "assets/images/gym-pro/gym-cable-rope-handle.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Drabinki i drobny sprzęt",
    name: "Pojedynczy uchwyt do wyciągu obrotowy ogumowany PROUD",
    quantity: "2 szt.",
    priceRaw: 165.62,
    unitNote: "82,81 zł za szt.",
    source: "Training Showroom",
    url: "https://trainingshowroom.com/maszyny-silowe/2587-pojedynczy-uchwyt-do-wyciagu-obrotowy-ogumowany-proud.html",
    image: "assets/images/gym-pro/gym-single-cable-handle.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Opcjonalne uzupełnienie",
    name: "Kettlebell żeliwny PRO, zestaw PROUD",
    quantity: "1 zestaw",
    priceRaw: 2625.99,
    source: "Training Showroom, opcjonalnie",
    url: "https://trainingshowroom.com/hantle-i-kettlebells/3465-hantla-proud-kettlebell-zestaw.html",
    image: "assets/images/gym-pro/gym-kettlebell-set.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Opcjonalne uzupełnienie",
    name: "Podłoga gumowa Standard PROUD 15 mm pod kettlebell",
    quantity: "10 szt.",
    priceRaw: 1199.9,
    unitNote: "119,99 zł za szt.; strefa ok. 3 x 3 m + puzzel pod odważniki kettlebell",
    source: "Training Showroom, opcjonalnie",
    url: "https://trainingshowroom.com/podlogi/3427-podloga-gumowa-standard-proud.html",
    image: "assets/images/gym-pro/gym-rubber-tile.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Wyposażenie AV",
    name: "Lustra na jedną ścianę pomieszczenia",
    quantity: "ok. 16 m²",
    priceRaw: 6500,
    source: "Cena orientacyjna, jedna pełna ściana",
    url: "",
  ...
  },
  {
    ...
    section: "Siłownia",
    group: "Wyposażenie AV",
    name: "Ekran projekcyjny elektryczny Avtek Cinema Electric 300P",
    quantity: "1",
    priceRaw: 1419,
    source: "x-kom",
    url: "https://www.x-kom.pl/p/711610-ekran-projekcyjny-avtek-ekran-elektryczny-cinema-electric-300p.html",
    image: "assets/images/equipment/projector-screen-avtek-electric-300p.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Wyposażenie AV",
    name: "Kabel HDMI światłowodowy 20 m Claroc",
    quantity: "1",
    priceRaw: 209,
    source: "x-kom",
    url: "https://www.x-kom.pl/p/1277224-kabel-hdmi-claroc-optyczny-hdmi-21-8k-120hz-20m.html",
    image: "assets/images/equipment/hdmi-optical-20m.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Wyposażenie AV",
    name: "Zestaw stereo Bluetooth Triangle AIO TWIN",
    quantity: "1 komplet",
    priceRaw: 2990,
    source: "AVstore",
    url: "https://avstore.pl/monitory-aktywne/triangle-aio-twin-aktywne-kolumny-podstawkowe-z-bluetooth-wi-fi.html",
    image: "assets/images/equipment/audio-stereo-triangle.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Wyposażenie AV",
    name: "Zestaw mikrofonowy nagłowny Tonsil ZP 12",
    quantity: "1 komplet",
    priceRaw: 1699,
    source: "AVstore",
    url: "https://avstore.pl/naglosnienie-przenosne/zestaw-tonsil-zp-12-przenosny-bezprzewodowy-system-naglosnieniowy-pa-mikrofon-uhf-mikrofon-naglowny-statyw-m502-102.html",
    image: "assets/images/equipment/audio-headset-pa.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Wyposażenie AV",
    name: "Uchwyty ścienne do głośników Gravity SP WMBS 30 B",
    quantity: "2 szt.",
    priceRaw: 319.98,
    unitNote: "159,99 zł za szt.",
    source: "ABLO Sklep",
    url: "https://www.ablosklep.com/gravity-sp-wmbs-30-b-wychylny-obrotowy-uchwyt-scienny-do-glosnikow-do-30-kg-czarny-p-3991.html",
    image: "assets/images/equipment/audio-wall-mount.jpg",
  },
  {
    category: "silownia",
    section: "Siłownia",
    group: "Wyposażenie AV",
    name: "Kabel audio mini jack 3,5 mm - 2x RCA 10 m Lindy",
    quantity: "1",
    priceRaw: 67,
    source: "RMS",
    url: "https://sklep.rms.pl/lindy-35337-kabel-mini-jack-3-5mm-2x-rca-cromo-line-10m",
    image: "assets/images/equipment/audio-jack-rca.jpg",
  },
  {
    category: "korekcyjna",
